...
import br.com.globalcode.lab5.model.*;
import br.com.globalcode.cp.state.*;
...
public class MainUI extends javax.swing.JFrame implements UIForm {
  ...
  private void initComponents() {
    ...
    jPanel3Layout.setHorizontalGroup(
      ...
      .add(jPanel3Layout.createSequentialGroup()
        ...
        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        .add(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
          .add(textID, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 305, Short.MAX_VALUE)
          .add(textOwner, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 305, Short.MAX_VALUE)
          .add(org.jdesktop.layout.GroupLayout.TRAILING, textModelo, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 305, Short.MAX_VALUE)
          .add(textComponente, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 305, Short.MAX_VALUE))
        .addContainerGap())
    );
  ...
  private void buttonAnteriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAnteriorActionPerformed
    //Command anterior
    dataCurrent=dataIterator.componenteAnterior();
    this.changeState(STATE_VIEW);
