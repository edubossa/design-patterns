<%@ page contentType="text/html; charset=iso-8859-1" language="java" import="br.com.globalcode.idp.model.Curso" errorPage="" %>
<html>
<head>
...
<table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC">
  ...
  <tr> 
    ...
    <td width="73%" valign="top"><p class="Campo">Erro de estrutura web (CommandException). 
